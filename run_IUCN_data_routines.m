function [IUCN_data_object] = run_IUCN_data_routines(IUCN_data_params)
    tic
    ...
    if strcmp(IUCN_data_params.system_type, 'EORA')
        ...
        [x_UN, industry_codes_to_use] = build_x_from_EORA_data(IUCN_data_params.EORA_x_filename, UN_to_IUCN_codes); 
    ...
    IUCN_data_object.IUCN_status_names = unique(IUCN_data_object.IUCN_status_list); % 11 threat levels (VUlnerable,EXtinct, etc)    
...
function [x_UN, industry_codes_to_use] = build_x_from_EORA_data(EORA_x_filename, UN_to_IUCN_codes)       
...
function IUCN_data_object = build_from_new_IUCN_data(new_IUCN_data_threats_filename, new_IUCN_data_species_filename, industry_codes_to_use, IUCN_industry_codes)
...
function IUCN_data_object = build_from_old_IUCN_data(old_IUCN_data_filename)
...
%     non_export_data = cellfun('isempty', export_data);
    ...
    [GHG_UN, GHG_industry_codes] = build_IUCN_industries_data(country_codes_list, industry_data_list, commodities_data_list, ...
                                        numerical_industry_data, UN_to_IUCN_codes);
...
function [industries_data_UN, industry_codes_to_use] = build_IUCN_industries_data(country_codes_list, industry_data_list, commodities_data_list, numerical_industry_data, UN_to_IUCN_codes)

    industries_data_UN = sort_EORA_data_to_UN(country_codes_list(industry_data_list), numerical_industry_data(industry_data_list), UN_to_IUCN_codes.UN_industry_codes);
    commodities_data_UN = sort_EORA_data_to_UN(country_codes_list(commodities_data_list), numerical_industry_data(industry_data_list), UN_to_IUCN_codes.UN_industry_codes);
