...
analyse_MRIO_params.assessment_type = 'final_sale_based'; %'production_based' or 'final_sale_based'
...
analyse_MRIO_params.threat_indexes_filename = [analyse_MRIO_params.datapath '/PostExclMarch/SpThrSubs_domestic_final.mat'] ;

analyse_MRIO_params.threat_vals_filename = [analyse_MRIO_params.datapath '/PostExclMarch/SpThrVals_domestic_final.mat'] ;
...
[ranked_MRIO_paths, ranked_aggregated_paths, ranked_expanded_paths, ranked_commodity_source_country_data, ranked_final_sale_country_data] = analyse_MRIO_output_routines(analyse_MRIO_params, IUCN_data_object, MRIO_threat_tensor, species_characteristics);
