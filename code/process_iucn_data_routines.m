function iucn_data_object = process_iucn_data_routines(iucn_data_params)
    ...
    if (iucn_data_params.build_iucn_data_object == false) && exist([iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/', iucn_data_params.iucn_data_object_filename], 'file')
        disp(['loading processed iucn data from ', [iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/', iucn_data_params.iucn_data_object_filename]])
        load([iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/', iucn_data_params.iucn_data_object_filename])
...
function iucn_data_object = build_iucn_data_object(iucn_data_params)
    ...
    if (iucn_data_params.save_processed_iucn_data == true)
        disp(['saving processed iucn data to ', [iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/', iucn_data_params.iucn_data_object_filename]])
        
        if ~exist([iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/'], 'dir')
            mkdir([iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/'])
        end
        
        save([iucn_data_params.output_data_filepath, iucn_data_params.system_type, '/', iucn_data_params.iucn_data_object_filename], 'iucn_data_object', '-v7.3');
    end
