...
function satellite_params = process_params(satellite_params, iucn_data_object)
    ...
    elseif ismember(satellite_params.species_taxons_to_use, iucn_data_object.iucn_country_names)
       satellite_params.species_taxons_to_use =  iucn_data_object.iucn_taxons_list(strcmp(iucn_data_object.country_names_list, satellite_params.species_taxons_to_use));
    end
%     if  strcmp(satellite_params.species_taxons_to_use, 'all')
...
function global_satellite = build_global_satellite(iucn_data_object, satellite_params)
    ...
    global_threats = aggregate_iucn_tensor('global', satellite_params.global_threats_to_aggregate, iucn_data_object, satellite_params);
...
function current_satellite = aggregate_iucn_tensor(satellite_type, threats_to_aggregate, iucn_data_object, satellite_params)
    ...
    if (satellite_params.return_satellite == true)
     ...
     if strcmp(satellite_params.tensor_scale, 'country')
        ...
        for country_index = country_indexes_to_use
            ...
            disp([iucn_data_object.iucn_country_code_names{country_index}, ' ', satellite_type, ' aggregated at ' num2str(toc)])
