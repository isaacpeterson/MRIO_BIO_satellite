...
%         
%         filename = strcat(analyse_MRIO_params.output_folder, analyse_MRIO_params.country_of_interest, '_net_', analyse_MRIO_params.finalsale_scale, '_finalsale_scale.txt');
