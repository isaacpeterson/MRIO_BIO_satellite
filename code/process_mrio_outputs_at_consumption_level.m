function trade_characteristics = process_mrio_outputs_at_consumption_level(iucn_data_object, analyse_mrio_params, species_characteristics, processed_finalsale_data)
    ...
    trade_characteristics.country_scale.finalsale_data_grouped_by_consumption_country = process_mrio_at_consumption_level(analyse_mrio_params, iucn_data_object, species_characteristics, country_indexes_to_use');
...
function country_scale_consumption = process_mrio_at_consumption_level(analyse_mrio_params, iucn_data_object, species_characteristics, country_indexes_to_use)
