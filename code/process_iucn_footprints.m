...
function current_footprint = select_footprint_subset(current_footprint, country_of_interest, impact_assessment_level, species_group_to_use, industry_characteristics)
