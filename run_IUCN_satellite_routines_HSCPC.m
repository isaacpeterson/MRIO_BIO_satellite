function [domestic_satellite, global_satellite, satellite_params] = run_IUCN_satellite_routines_HSCPC(IUCN_data_object, satellite_params)
    tic
    satellite_params = process_params(satellite_params, IUCN_data_object);
    
    disp('collapsing domestic tensors to user specification')
           
    [domestic_satellite, satellite_params] = build_domestic_satellite(IUCN_data_object, satellite_params); 

    global_satellite = build_global_satellite(IUCN_data_object, satellite_params);  
...
function [domestic_satellite, satellite_params] = build_domestic_satellite(IUCN_data_object, satellite_params)
   ...
   domestic_satellite = aggregate_countries('domestic', satellite_params.domestic_threats_to_aggregate, satellite_params.build_domestic_satellite, IUCN_data_object, satellite_params);
...
function global_satellite = build_global_satellite(IUCN_data_object, satellite_params)
    ...
    global_threats = aggregate_countries('global', satellite_params.global_threats_to_aggregate, true, IUCN_data_object, satellite_params);
