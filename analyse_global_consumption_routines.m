function trade_characteristics = analyse_global_consumption_routines(IUCN_data_object, analyse_MRIO_params, species_characteristics)
    ...
    trade_characteristics.country_scale.unique_countries = unique(IUCN_data_object.industry_characteristics.country_names_list, 'stable'); 
    trade_characteristics.country_scale.grouped_countries = build_consumption_level_data(analyse_MRIO_params, IUCN_data_object, species_characteristics);
    
    trade_characteristics.sector_to_sector_scale = expand_sector_to_sector_finasale_data(trade_characteristics.country_scale.unique_countries, trade_characteristics.country_scale.grouped_countries, IUCN_data_object);

    trade_characteristics.aggregated_sector_scale = expand_aggregated_sector_scale_data(trade_characteristics.country_scale.grouped_countries, trade_characteristics.country_scale.unique_countries);
    ...
    trade_characteristics.country_scale.species_counts = build_country_scale_species_counts(trade_characteristics.aggregated_sector_scale, trade_characteristics.finalsale_data, numel(trade_characteristics.country_scale.grouped_countries), analyse_MRIO_params, species_characteristics);
    ...
    trade_characteristics.country_scale.consumption_characteristics = run_consumption_production_assessment(trade_characteristics.sector_to_sector_scale.consumption_country_list, trade_characteristics.sector_to_sector_scale, ...
                                                                                                            trade_characteristics.country_scale.unique_countries, trade_characteristics.country_scale.species_counts, analyse_MRIO_params);
...
function country_scale_consumption = build_consumption_level_data(analyse_MRIO_params, IUCN_data_object, species_characteristics)
...
function aggregated_sector_scale = expand_aggregated_sector_scale_data(consumption_country_set, unique_countries)
...
function species_counts = build_country_scale_species_counts(aggregated_sector_scale, finalsale_data, country_num, analyse_MRIO_params, species_characteristics)
...
function sector_to_sector_scale = expand_sector_to_sector_finasale_data(unique_countries, consumption_country_set, IUCN_data_object)
    ...
    sector_to_sector_scale.consumption_country_list = cellfun(@(x, y) repmat(y, [size(x, 1) 1]), ...
                                                              sector_to_sector_scale.finalsale_production_sectors, num2cell(1:length(unique_countries))','UniformOutput', false);
...
function country_scale_trade_characteristics = run_country_scale_net_trade_assessment(trade_characteristics)
    ...
    country_scale_trade_characteristics.table = [trade_characteristics.country_scale.consumption_characteristics.table...
                                                 cell2table([num2cell(trade_characteristics.country_scale.net_trade_characteristics.net_threat_intensity)...
                                                             num2cell(trade_characteristics.country_scale.production_characteristics.threat_intensities_international)], ... 
                                                         'VariableNames', {'exports', 'net'})];

end



function country_scale_trade_characteristics = run_consumption_production_assessment(block_to_use, sector_to_sector_scale, unique_countries, species_counts, analyse_MRIO_params)
    
    unique_country_inds = arrayfun(@(x) {x}, (1:length(unique_countries))');

    country_scale_trade_characteristics = struct();
    country_scale_trade_characteristics.global_blocks = cellfun(@(x) block_to_use == x, unique_country_inds, 'UniformOutput', false);
...
function low_income_characteristics = build_low_income_trade_characteristics(trade_characteristics, analyse_MRIO_params, unique_countries)
    ...
    low_income_characteristics.low_income_imported_threats = cellfun(@(x) sum(trade_characteristics.sector_to_sector_scale.finalsale_production_threat_intensities(x)), low_income_characteristics.import_indexes);
                                  
    low_income_characteristics.low_income_international_proportion = low_income_characteristics.low_income_imported_threats ./ trade_characteristics.country_scale.consumption_characteristics.threat_intensities_international;
    
    low_income_characteristics.table = cell2table([unique_countries num2cell([low_income_characteristics.low_income_imported_threats ...
                                                                                    low_income_characteristics.low_income_international_proportion...
